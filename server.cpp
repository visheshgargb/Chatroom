...
int broadcasted_message(string message, int sender_id);
int broadcasted_message(int num, int sender_id);
...
void handle_client(int client_socket, int id){
	...
	broadcasted_message("#NULL",id);	
	broadcasted_message(id,id);								
	broadcasted_message(welcome_message,id);	
	...
	while(true){
		...
		if(strcmp(str,"#exit")==0){
			...
			broadcasted_message("#NULL",id);			
			broadcasted_message(id,id);						
			broadcasted_message(message,id);
			shared_print(color(id)+message+def_col);
			end_connection(id);							
			return;
		}
		broadcasted_message(string(name),id);					
		broadcasted_message(id,id);		
		broadcasted_message(string(str),id);
